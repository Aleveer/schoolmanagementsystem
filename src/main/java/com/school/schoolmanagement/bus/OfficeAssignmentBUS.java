...
import src.main.java.com.school.schoolmanagement.dal.OfficeAssignmentDAL;
import src.main.java.com.school.schoolmanagement.models.OfficeAssignmentModel;
...
public class OfficeAssignmentBUS {
    ...
    public int addModel(OfficeAssignmentModel OfficeAssignmentModel) {
        if (OfficeAssignmentModel.getInstructorID() <= 0
                ...
                || OfficeAssignmentModel.getTimestamp() == null
                || OfficeAssignmentModel.getTimestamp().getTime() <= System.currentTimeMillis()) {
