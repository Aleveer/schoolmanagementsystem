...
public class PersonDAL {
    ...
    public int update(PersonModel person) {
        String updateSql = "UPDATE users SET Lastname = ?, Firstname = ?, HireDate = ?, EnrollmentDate = ? WHERE PersonID = ?";
        Object[] args = {
                person.getLastName(),
                person.getFirstName(),
                person.getHireDate(),
    ...
    public List<PersonModel> search(String condition, String[] columnNames) {
        try {
            ...
            StringBuilder queryBuilder = new StringBuilder("SELECT PersonID, Lastname, Firstname, HireDate, EnrollmentDate FROM Person WHERE ");
