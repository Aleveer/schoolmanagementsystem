...
public class DepartmentDAL {
    ...
    public int insert(DepartmentModel department) {
        ...
        Object[] args = {department.getDepartmentID(),department.getName(),department.getBudget(),department.getStartDate(),department.getAdministrator()};
        try {
    ...
    public List<DepartmentModel> search(String condition, String[] columnNames) {
        try {
            ...
            StringBuilder queryBuilder = new StringBuilder("SELECT DepartmentID, Name, Budget, StartDate, Administrator FROM Department WHERE ");
